...
import {TeacherService} from '../teacher-page/teacher.service';
...
export class AdminPageComponent implements OnInit {
  ...
  clkButDeleteAllAdmins() {
    if(this.mathTask())
    {
      ...
      console.log(this.dataSrcAllAdmins);
    }
  }
  ...
  clkButDeleteAllReqStud() {
    if(this.mathTask())
    {
      ...
      console.log(this.dataSrcRequestStud);
    }
  }
  ...
  clkButDeleteAllStud() {
    if(this.mathTask())
    {
      ...
      this.dataSrcAllStud = [];
      console.log(this.dataSrcAllStud);
    }
  }
  ...
  clkButDeleteReqTeachers()
  {
    if(this.mathTask())
    {
      ...
      console.log(this.dataSrcRequestTeachers);
    }
  }
